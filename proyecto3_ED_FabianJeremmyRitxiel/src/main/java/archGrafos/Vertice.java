...
public class Vertice {
    ...
    public Posiciones posAtaques;

    // cosntructor
    public Vertice(int tempX, int tempY, int tipo, Posiciones tempPosAta)
    {
        ...
        if (tipo == 1){
            ...
            this.isla = new islaMercado(tempX, tempY); //agrega mercado
        }
        else if (tipo == 3){
            this.isla = new islaConector(tempX, tempY); //agrega conector
        }
        else if (tipo == 4){
            this.isla = new islaArmeria(tempX, tempY); //agrega armeria
        }
        else if (tipo == 5){
    ...
    public void agregarArista (Vertice arista)
    {
        ...
        if (buscarArista(arista) == -1)
            aristas.add(new Vertice(arista.posX , arista.posY , 0 , null));
    }
